        ...
        <div class="flex items-center gap-4">
          <template v-if="userStore.isLoggedIn">
            <NuxtLink to="/account">
              ...
              <div class="flex items-center gap-6 pr-4 border-r border-gray-200">
                <div class="flex items-center gap-3">
                  <div class="flex flex-col items-end">
                    <span class="text-sm font-medium text-gray-900 leading-none">
                      {{ userStore.userName }}
                    </span>
                  </div>
                  <div
                    class="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700 font-semibold border-2 border-white shadow-sm">
          ...
          <template v-else>
            <NuxtLink to="/login" class="text-sm font-medium text-gray-600 hover:text-indigo-600 transition-colors">
              Connexion
            </NuxtLink>
