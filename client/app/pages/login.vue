  ...
  <AuthCard>
    ...
    <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
      <div class="space-y-4">
        ...
        <AuthInput id="password" v-model="password" label="Mot de passe" type="password" autocomplete="current-password"
    ...
    <template #footer>
      ...
      <NuxtLink to="/register" class="ml-1 font-semibold text-indigo-600 hover:text-indigo-500 transition-colors">
